...
def proc_data(sfo, syr, igpi):
    ...
    vn1=load_data(md,sfo,varn1,igpi,syr)
    print('Loading %s...'%varn2)
    vn2=load_data(md,sfo,varn2,igpi,syr)
    print('Loading tas...')
    tas=load_data(md,sfo,'tas',igpi,syr)
...
def plot(relb):
    ...
    vn1h, vn2h, btash, pvn = proc_data(fo1, yr1, igpi)
    vn1f, vn2f, btasf, _   = proc_data(fo2, yr2, igpi)
